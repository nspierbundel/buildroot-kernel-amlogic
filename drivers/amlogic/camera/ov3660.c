...
static int vidioc_streamon(struct file *file, void *priv, enum v4l2_buf_type i)
{
	...
	para.fmt_info.frame_rate = ov3660_frmintervals_active.denominator * 10
					/ov3660_frmintervals_active.numerator;//175

	dprintk(dev, 3,"streamon framerate=%d\n",para.fmt_info.frame_rate);
	para.fmt_info.h_active = ov3660_h_active;
	para.fmt_info.v_active = ov3660_v_active;
	para.fmt_info.hsync_phase = 0;//0x1
	para.fmt_info.vsync_phase  = 1;//0x1

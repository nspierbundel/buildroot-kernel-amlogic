...
static int vidioc_streamon(struct file *file, void *priv, enum v4l2_buf_type i)
{
	...
	para.fmt_info.frame_rate = 150;//150
	para.fmt_info.h_active = 640;//640
	para.fmt_info.v_active = 480;//480
	para.fmt_info.hsync_phase = 1;//0
	para.fmt_info.vsync_phase  = 1;//1	

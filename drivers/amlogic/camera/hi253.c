...
static int vidioc_streamon(struct file *file, void *priv, enum v4l2_buf_type i)
{
    ...
    para.fmt_info.fmt = TVIN_SIG_FMT_MAX+1;//TVIN_SIG_FMT_CAMERA_1280X720P_30Hz;//TVIN_SIG_FMT_MAX+1;;TVIN_SIG_FMT_CAMERA_1280X720P_30Hz
	para.fmt_info.frame_rate = 150;//236;
	para.fmt_info.h_active = hi253_h_active;//800
	para.fmt_info.v_active = hi253_v_active;//600
